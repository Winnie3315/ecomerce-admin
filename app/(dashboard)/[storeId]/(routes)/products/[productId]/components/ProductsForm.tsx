...
// const ProductsForm: React.FC<ProductsFormProps> = ({ initialData, categories, sizes, colors }) => {
...
//         </FormLabel>
//         <FormControl>
//             <Input className="" disabled={loading} placeholder="Product name" {...field} />
//         </FormControl>
//         <FormMessage />
//     </FormItem>
// )} />
...
//         </FormLabel>
//         <FormControl>
//             <Input type="number" className="" disabled={loading} placeholder="$4.99" {...field} />
//         </FormControl>
//         <FormMessage />
//     </FormItem>
// )} />
...
const ProductsForm: React.FC<ProductFormData> = ({
    initialData,
    categories,
    sizes,
    colors,
